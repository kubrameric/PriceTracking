package com.bitirme.webscraper.kafka.consumer.config;
...
public class KafkaConsumerConfiguration {
    ...
    public ConsumerFactory<String, ScraperEventDto> consumerFactory(
        ...
        return new DefaultKafkaConsumerFactory<>(config,
                ...
                new JsonDeserializer<>(ScraperEventDto.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ScraperEventDto> consumerListenerFactory(ConsumerFactory<String,ScraperEventDto> consumerFactory){
        ConcurrentKafkaListenerContainerFactory<String, ScraperEventDto> factory = new ConcurrentKafkaListenerContainerFactory<>();
